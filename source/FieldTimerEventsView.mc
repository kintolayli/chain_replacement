...
class FieldTimerEventsView extends WatchUi.DataField
{
    ...
    private var _lapNumber as Lang.Float = 300000;
    private var _currentDistance as Lang.Float = 0;
    ...
    public function onTimerStop() as Void {
        _lapNumber = _lapNumber - _currentDistance;
    ...
    public function onTimerReset() as Void {
        ...
        _timerState = STATE_STOPPED;
        _lapCertainty = "";
        Storage.setValue("distance", _lapNumber);
    }
    ...
    public function compute(info as Info) as Void {
        ...
        _currentDistance = info.elapsedDistance;
    }
    ...
    public function onUpdate(dc as Dc) as Void {
        ...
        if (WatchUi.DataField has :onTimerLap) {
            var dataColor = Graphics.COLOR_BLACK;
